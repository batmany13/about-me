# Thinking with Claude — Leadership Musings
...
Fast Takes started as a transparency practice — a weekly newsletter sharing what I was working on so my org had visibility into leadership priorities.  Over time the *why* evolved.  It became a vehicle for **context absorption** — reading broadly across the org, industry, and technology landscape, then writing short summaries so people didn't have to wade through everything themselves.  And then it slowly pivoted again, becoming something I wrote primarily for myself: a forcing function to actively process information rather than passively consume it.

The paradox is that this inward pivot made it *more* valuable to others, not less.  People kept reading.  Multiple people have commented on the consistency, mentioned finding unexpected nuggets, or said they rely on it to stay current.  A newsletter written to understand reads differently than one written to perform transparency.  The selfish motivation produced the more authentic artifact.
...
Culture kept Netflix relevant through pivots — DVD to streaming, licensing to originals, US to global — and is enabling the current wave: Live events, Games, Ads, and Podcasts.  Each required cannibalizing something currently working or betting on something unproven.  Most companies structurally cannot do this, not because their leaders aren't smart enough to see it coming, but because the organizational immune system kills the pivot before it becomes action.  Culture — specifically the low politics, high trust architecture — removes enough friction that leadership can actually execute the pivot when they call it.
